package hchh.struts2.action.user;

import hchh.com.demo.DesignerDemo;
import hchh.hibernate.dao.ActivityDao;
import hchh.hibernate.dao.DesignerDao;
import hchh.hibernate.dao.GroupDao;
import hchh.hibernate.dao.HeadPhotoDao;
import hchh.hibernate.dao.RoleDao;
import hchh.hibernate.dao.SupplierDao;
import hchh.hibernate.dao.UserDao;
import hchh.hibernate.dao.WordbookDao;
...
import hchh.struts2.action.HchhAction;
import hchh.struts2.service.CommService;
...
public class UserHandleAction extends HchhAction{
	...
	private DesignerDemo designer=new DesignerDemo();
	private DesignerDemo supplier=new DesignerDemo();
	int ok=0;
	...
	public DesignerDemo getDesigner() {
		return designer;
	}
	public void setDesigner(DesignerDemo designer) {
		this.designer = designer;
	}
	public DesignerDemo getSupplier() {
		return supplier;
	}
	public void setSupplier(DesignerDemo supplier) {
