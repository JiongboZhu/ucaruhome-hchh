...
<script type="text/javascript">
	function chakan(userId){
	   //alert(userId);
	   top.Dialog.open({URL:"lesson/findOneDesignerUser.action?userId="+userId,Title:"设计师信息 ",Width:950,Height:400});
	}
	
	
	function prePage(nowPage){
	top.window.frmright.frmrightChild.location="findDesignerUsersShenHeOver.action?designer=0&nowPage="+nowPage;
	}
