...
<script type="text/javascript">
	...
	function tijiaoCS(id){
	 top.Dialog.confirm("确定要提交重审？",function(){
	   $.post(
	    "chongxinShenheInformationflow.action",
	    {"id":id,"informationflowState":0},
	    function(data){
	      if(data.ok){
	        top.window.frmright.location.href=top.window.frmright.location.href;
	        top.Dialog.close();
...
<div id="scrollContent">
    <fieldset> 
		...
		<table style="width: 100%;">
		    <tr><td style="text-align:right;" colspan="8"><input type="button" value="提交重审" onclick="tijiaoCS(${informationflow.id})"/></td></tr>
			<tr>
