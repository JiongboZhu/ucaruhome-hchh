...
<script type="text/javascript">
	...
	function chakan(userId){
	   //alert(userId);
	   top.Dialog.open({URL:"lesson/queryUserDSH.action?userId="+userId,Title:"查看用户 ",Width:950,Height:600});
	}
	...
	top.window.frmright.frmrightChild.location="findUsersDRZ.action?nowPage="+nowPage;
	}
